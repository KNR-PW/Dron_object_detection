# PROGRAM DO ZMIANY KLASY W PLIKACH YOLO 
# Struktura działania:
# 1. Użytkownik wybiera katalogi z plikami YOLO (3 katalogi), (katalog to te z plikami tekstowymi)
# 2. Użytkownik podaje nową wartość klasy dla każdego katalogu (cyfra).
# 3. Program przeszukuje pliki tekstowe w każdym katalogu i zmienia wartość klasy na podaną przez użytkownika.
# 4. Program informuje o zakończeniu operacji.
